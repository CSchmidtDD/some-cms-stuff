...
define('MODULE_SHIPPING_TABLE_TEXT_TITLE', 'Versandkosten');
define('MODULE_SHIPPING_TABLE_TEXT_DESCRIPTION', 'Versandkosten');
define('MODULE_SHIPPING_TABLE_TEXT_WAY', 'Standard Versand');
