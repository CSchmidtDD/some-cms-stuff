<?php /* Smarty version 2.6.27, created on 2015-10-15 17:17:36
         compiled from delice24/module/product_listing/product_listing_v1.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'delice24/module/product_listing/product_listing_v1.html', 1, false),array('modifier', 'strip_tags', 'delice24/module/product_listing/product_listing_v1.html', 21, false),array('modifier', 'html_entity_decode', 'delice24/module/product_listing/product_listing_v1.html', 21, false),array('modifier', 'truncate', 'delice24/module/product_listing/product_listing_v1.html', 21, false),array('modifier', 'strstr', 'delice24/module/product_listing/product_listing_v1.html', 25, false),array('modifier', 'string_format', 'delice24/module/product_listing/product_listing_v1.html', 26, false),)), $this); ?>
...
<h2><?php echo $this->_tpl_vars['CATEGORIES_HEADING_TITLE']; ?>
</h2>
<?php if ($this->_tpl_vars['CATEGORIES_DESCRIPTION']): ?>
<p><?php echo $this->_tpl_vars['CATEGORIES_DESCRIPTION']; ?>
</p>
<?php endif; ?>
<?php if ($this->_tpl_vars['MANUFACTURER_DROPDOWN']): ?><?php echo $this->_tpl_vars['MANUFACTURER_DROPDOWN']; ?>
<?php endif; ?>
...
g
 ...
 |
		        <?php endif; ?>
					<?php if ($this->_tpl_vars['module_data']['PRODUCTS_SHIPPING_NAME']): ?><p class="shippingtime"><?php echo $this->_config[0]['vars']['text_shippingtime']; ?>
<?php if ($this->_tpl_vars['module_data']['PRODUCTS_SHIPPING_IMAGE']): ?><img src="<?php echo $this->_tpl_vars['module_data']['PRODUCTS_SHIPPING_IMAGE']; ?>
" alt="<?php echo $this->_tpl_vars['module_data']['PRODUCTS_SHIPPING_NAME']; ?>
" /><?php endif; ?>
					<?php echo $this->_tpl_vars['module_data']['PRODUCTS_SHIPPING_NAME_LINK']; ?>
</p>
					<?php endif; ?>						
