<?php /* Smarty version 2.6.27, created on 2016-12-12 12:34:36
         compiled from delice24/mail/german/order_mail.html */ ?>
...
,<br>
        <br>
		Ihre Bestellung wurde soeben von einem unserer Mitarbeiter bestätigt.<br>
		Wir bemühen uns umgehend, ihre Ware zusammenzustellen und alsbald zu versenden.</font><br>
		<br>
        ...
        <strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Ihre Anmerkungen:</font></strong><br>
...
<?php if ($this->_tpl_vars['NEW_PASSWORD']): ?>
        <br><br>
        <strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Ihr Account Passwort:</font></strong><br>
        <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><?php echo $this->_tpl_vars['NEW_PASSWORD']; ?>
</font><br><br>
<?php endif; ?>        
      </p></td>
  </tr>
