<?php /* Smarty version 2.6.27, created on 2015-10-17 03:40:57
         compiled from delice24/module/create_account.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'delice24/module/create_account.html', 1, false),)), $this); ?>
...
<h2><?php echo $this->_config[0]['vars']['heading_create_account']; ?>
</h2>
...
<h3><?php echo $this->_config[0]['vars']['title_password']; ?>
</h3>
<div class="highlightbox">
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr> 
    <td width="120"><?php echo $this->_config[0]['vars']['text_password']; ?>
</td>
    <td><?php echo $this->_tpl_vars['INPUT_PASSWORD']; ?>
</td>
  </tr>
  <tr> 
    <td><?php echo $this->_config[0]['vars']['text_confirmation']; ?>
</td>
    <td><?php echo $this->_tpl_vars['INPUT_CONFIRMATION']; ?>
</td>
  </tr>
</table>
</div>
...
<p><?php echo $this->_config[0]['vars']['text_must']; ?>
</p>
