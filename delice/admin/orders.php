  ...
  case 'update_order' :
    ...
    if ($check_status['orders_status'] != $status || $comments != '') {
      ...
      if ($_POST['notify'] == 'on') {
        ...
        $smarty->assign('logo_path', HTTP_SERVER.DIR_WS_CATALOG.'imgages/');
      ...
      <table cellspacing="0" cellpadding="2" style="width:850px; margin-bottom:10px;">
        <tr>
          <td align="right">
			...
			<a class="button" href="<?php echo xtc_href_link(FILENAME_ORDERS, xtc_get_all_get_params(array ('oID', 'action')).'oID='.$oID.'&action=send&sta=0&stc=1&site=1');?>"  onClick="window.open('<?php echo xtc_href_link(FILENAME_PRINT_PACKINGSLIP_PDF,'oID='.$_GET['oID'].'&send=1'); ?>', 'popup', 'toolbar=0, width=640, height=600'); "><?php echo BUTTON_ORDER_CONFIRMATION; ?></a>
            <?php
            ...
            ?>
			<a class="button" href="Javascript:void(0)"  onClick="window.open('<?php echo xtc_href_link(FILENAME_PRINT_ORDER_PDF,'oID='.$_GET['oID'].'&send=1'); ?>', 'popup', 'toolbar=0, width=640, height=600'); "><?php echo 'Versendet'; ?></a>
            <?php 
			...
			<a class="button" href="Javascript:void(0)" onClick="window.open('<?php echo xtc_href_link(FILENAME_PRINT_ORDER_PDF,'oID='.$_GET['oID']); ?>', 'popup', 'toolbar=0, width=640, height=250')"><?php echo BUTTON_INVOICE_PDF; ?></a>
			<?php
			} else {
			?>
			...
			<a class="button" href="Javascript:void(0)"  onClick="window.open('<?php echo xtc_href_link(FILENAME_PRINT_PACKINGSLIP_PDF,'oID='.$_GET['oID']); ?>', 'popup', 'toolbar=0, width=640, height=250'); "><?php echo BUTTON_PACKINGSLIP_PDF; ?></a>
			<?php
			// PDFBill NEXT change End
			?>
